...
func (s *AuthorService) GetByID(ctx context.Context, id uint64) (*dto.AuthorResponse, error) {
...
func (s *AuthorService) Update(ctx context.Context, id uint64, req dto.UpdateAuthorRequest) (*dto.AuthorResponse, error) {
...
func mapAuthorToResponse(a *models.Author) dto.AuthorResponse {
